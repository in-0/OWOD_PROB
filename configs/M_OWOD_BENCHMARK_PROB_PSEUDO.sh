...
EXP_DIR=exps/MOWODB/PROB_PSEUDO
PY_ARGS=${@:1}
WANDB_NAME=PROB_PSEUDO_V0_warmup
...
python -u main_open_world.py \
    ...
    --model_type 'prob_pseudo' --obj_loss_coef 8e-4 --obj_temp 1.3\
    --resume "${EXP_DIR}/t1/checkpoint0040.pth"\
...
python -u main_open_world.py \
    ...
    --model_type 'prob_pseudo' --obj_loss_coef 8e-4 --obj_temp 1.3 --freeze_prob_model\
    ...
    --pretrain "${EXP_DIR}/t1/checkpoint0040.pth" --lr 2e-5 --unmatched_boxes --nc_epoch 9 \
    ${PY_ARGS}
...
python -u main_open_world.py \
    ...
    --pretrain "${EXP_DIR}/t2/checkpoint0050.pth" --unmatched_boxes --nc_epoch 9 \
    ${PY_ARGS}
...
# python -u main_open_world.py \
    ...
    # --model_type 'prob_pseudo' --obj_loss_coef 8e-4 --freeze_prob_model --obj_temp 1.3\
    ...
    # --pretrain "${EXP_DIR}/t2_ft/checkpoint0110.pth" --lr 2e-5 --unmatched_boxes --nc_epoch 9 \
    # ${PY_ARGS}
#
#
# PY_ARGS=${@:1}
# python -u main_open_world.py \
    ...
    # --pretrain "${EXP_DIR}/t3/checkpoint0120.pth" --unmatched_boxes --nc_epoch 9 \
    # ${PY_ARGS}
#
#
# PY_ARGS=${@:1}
# python -u main_open_world.py \
    ...
    # --pretrain "${EXP_DIR}/t3_ft/checkpoint0180.pth" --lr 2e-5 --unmatched_boxes --nc_epoch 9 \
    # ${PY_ARGS}
#
#
# PY_ARGS=${@:1}
# python -u main_open_world.py \
    ...
    # --pretrain "${EXP_DIR}/t4/checkpoint0190.pth" --unmatched_boxes --nc_epoch 9 \
    # ${PY_ARGS}
