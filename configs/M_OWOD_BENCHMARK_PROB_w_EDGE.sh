...
EXP_DIR=exps/MOWODB/PROB_w_EDGE
PY_ARGS=${@:1}
WANDB_NAME=PROB_w_EDGE
...
python -u main_open_world.py \
    ...
    --model_type 'prob_w_edge' --obj_loss_coef 8e-4 --obj_temp 1.3\
...
python -u main_open_world.py \
    ...
    --model_type 'prob_w_edge' --obj_loss_coef 8e-4 --obj_temp 1.3 --freeze_prob_model\
